...
Answer the question a reviewer asks about every design that claims to be robust: **how does a small
team know this system is healthy, and what do they do at 2am when it is not?**
...
- The honest constraint, and it belongs here: **a small team can sustain only a very short
...
- [ ] The small-team constraint on alert volume is named honestly, with no invented headcount number.
